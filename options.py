...
def set():
    ...
    parser.add_argument('--stopping-patience', type=int, default=1000, help='Stopping patience for every stage.')
    parser.add_argument('--stage-patience', type=int, default=20, help='Stopping patience for the number of stages in each outer loop.')
